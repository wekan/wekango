...
// Adapted from mongo-tools mongostat/main/mongostat.go at upstream
...
func runmongostat(args []string) (exitCode int) {
	// initialize command-line opts
	opts, err := mongostat.ParseOptions(args, VersionStr, GitCommit)
	if err != nil {
