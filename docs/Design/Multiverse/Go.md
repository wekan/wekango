...
> Implementation note: this design was copied from WeKan at `2037d4acb`.
> Wekango now implements it incrementally with a drop-in compatibility target.
> See [the roadmap](../../../ROADMAP.md) for tested progress and remaining work.
> The original evaluation below is retained as design rationale.
